...
forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == [self._activeSections count] -1) {
        ...
        section.info.isCalculatingHeight = NO;
        [section willDisplayCell:cell forSectionRow:indexPath.row];
    }
}
...
- (void)tableView:(UITableView *)tableView didDeselectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BHBlockTableSection *curSection = [self sectionForIndex:indexPath.section];
    BHBlockTableInfo *info = [curSection didDeselectSectionRow:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (info.deselectRowAutomatically) {
